...
> Voir aussi le repo jumeau [`sqlkiller`](https://github.com/Axolotty/sqlkiller) qui propose une version avec service systemd.
...
```bash
git clone https://github.com/Axolotty/killersql.git
cd killersql
chmod +x killersql
```
